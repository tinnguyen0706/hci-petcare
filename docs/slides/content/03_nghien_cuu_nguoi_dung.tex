...
\begin{frame}{Nghiên Cứu Người Dùng \& Phát Hiện Then Chốt}
  \framesubtitle{\color{PetcareSecondary}\textbf{Tiếng nói từ thực địa: Dữ liệu phỏng vấn và 4 phát hiện bước ngoặt}}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.40\textwidth}
      \begin{block}{\centering \scriptsize \textbf{Phương pháp nghiên cứu chuẩn HCI}}
        ...
        $\bullet$ \textbf{Khảo sát trực tuyến:} 5 chủ nuôi qua khảo sát trực tuyến.
      \end{block}
