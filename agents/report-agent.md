...
- **Linh hoạt theo thực tế dữ liệu & xử lý phần con không có thông tin**: Cấu trúc 9 chương là chuẩn mực HCI bắt buộc; nhưng ở các tiểu mục con (ví dụ 5.6 yêu cầu các phương án A, B, C...), nếu đồ án chỉ có 1 phương án duy nhất hoặc không có thông tin thì chỉ cần trình bày 1 phương án/thực tế của đồ án kèm **lý do hợp lý**, tuyệt đối không tự tạo phương án hay thông tin giả.
