...
6. **Sử dụng tool `render-html-to-png.py`**: Render hình ảnh độ nét cao, kích thước của 1 trang A4 cho từng Persona (`persona-1.png`, `persona-2.png`...).
7. **Trả về kết quả**: Danh sách các Persona hoàn chỉnh (gồm JSON, HTML, PNG (1 trang A4)) trong thư mục `deliverables/01-user-research/persona/`.
