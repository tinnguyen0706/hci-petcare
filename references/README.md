...
| Prototype | `course-materials/lectures/08_Design_Prototype.pdf` · [Markdown](course-materials/notes/08-prototype.md) | Bài giảng | CSC12106, Lê Thị Nhàn | Mức độ trung thực (fidelity), paper/video/functional prototype và vai trò của low-fi prototype |
| Thiết kế thị giác | `course-materials/lectures/09_Design_Visual_Design.pdf` · [Markdown](course-materials/notes/09-visual-design.md) | Bài giảng | CSC12106, Lê Thị Nhàn | Yếu tố thiết kế, nguyên lý thị giác (CRAP), bố cục, canh lề và khoảng trắng trong UI |
| Đánh giá tương tác | `course-materials/lectures/10_Evaluation.pdf` · [Markdown](course-materials/notes/10-evaluation.md) | Bài giảng | CSC12106, Lê Thị Nhàn | Focus group, Wizard-of-Oz, Usability test và phân tích thống kê định lượng |
